...
{
    /// <summary>
    /// Implementation as originally performed in GoRogue 2; uses a map-sized boolean array to speed up contains
    /// operations.
    /// </summary>
    [PublicAPI]
    internal class OriginalMapAreaFinder
    {
        ...
        {
            var areaFinder = new OriginalMapAreaFinder(map, adjacencyMethod);
