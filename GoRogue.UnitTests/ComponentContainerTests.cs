...
namespace GoRogue.UnitTests
{
    ...
    public class ComponentContainerTests
	{
		...
		[Fact]
		public void AddComponentBasic() // We cannot test retrieval until we test GetComponent, but we will test exception-based behaviors
		{
        ...
        [Fact]
        public void AddComponentTag() // We cannot test retrieval until we test GetComponent, but we will test exception-based behaviors
        {
            var component = new Component1();
            var component2 = new Component1();
