...
namespace GoRogue.Pathing
{
	...
	/// </summary>
	/// <remarks>
	/// This class encapsulates the work of building one overall goal map out of multiple existing maps.
	/// It holds references to one or more maps, each with its own "weight".  The higher the weight value,
	...
	class GoalMapCombiner : IMapView<double?>
	{
		...
		/// <summary>
		/// The list of weighted goal maps.  Can be used to add or remove goal maps, or
		/// change their weights.
		/// </summary>
		/// <remarks>When adding a new goal map, its Height and Width should be identical 
		/// to the Height and Width of the GoalMapCombiner.</remarks>
		...
		/// <summary>
		/// Computes the entire aggregate goal map.  This may be useful in situations where
		/// the goals are shared between many characters and do not change frequently.
		/// </summary>
