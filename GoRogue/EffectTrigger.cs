...
{
    /// <summary>
    /// Represents an "event" that can trigger one or more Effects of the appropriate type.
    /// Typically instnaces of this class can simply be created, however a subclass may be
    /// required for custom add/remove actions and ordering.
    /// </summary>
    /// <remarks>
    ...
    /// have an instance of this class called OnDamageTaken.  Any effect that should trigger
    /// when that creature takes damage would then be added to that creature's OnDamageTaken
    ...
    /// </remarks>
    /// <typeparam name="TriggerArgs">The type of argument that must be accepted by the Trigger
    /// function of any Effect added to this EffectTrigger.</typeparam>
    public class EffectTrigger<TriggerArgs> where TriggerArgs : EffectArgs
    {
        ...
        /// <summary>
        /// Adds the given effect to this EffectTrigger, provided the effect's duration
        /// is not 0.  If the effect's duration is 0, an ArgumentException is thrown.
        /// </summary>
        ...
        /// <summary>
        /// For each effect in the list, calls its Trigger function if its duration is not
        /// 0, then remvoes any effect that has duration 0.
        /// </summary>
        /// <remarks>
        /// The argument given is passed along to the Trigger function of each effect that
        /// has Trigger called.
        /// If some effect sets the CancelTrigger flag in the argument to true, the loop
