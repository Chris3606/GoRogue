...
namespace GoRogue
{
    ...
    public class EffectTrigger<TTriggerArgs> where TTriggerArgs : EffectArgs
    {
        ...
        /// Constructor.
        /// </summary>
        public EffectTrigger() => _effects = new List<Effect<TTriggerArgs>>();

        /// <summary>
        /// List of all effects that are part of this EffectTrigger.
        /// </summary>
        public IReadOnlyList<Effect<TTriggerArgs>> Effects => _effects.AsReadOnly();
        ...
        public virtual void Add(Effect<TTriggerArgs> effect)
        {
            if (effect.Duration == 0)
                throw new ArgumentException(
                    $"Tried to add effect {effect.Name} to an EffectTrigger, but it has duration 0!", nameof(effect));
