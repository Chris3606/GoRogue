...
namespace GoRogue.SpatialMaps
{
        ...
        where T : notnull
    {
        ...
        //void MoveValid(Point current, Point target, IList<T> itemsMovedOutput);
        ...
        /// <param name="targetY">Y-value of the location to move items to.</param>
        /// <param name="itemsMovedOutput">A list to which all items successfully moved are added.</param>
        //void MoveValid(int currentX, int currentY, int targetX, int targetY, IList<T> itemsMovedOutput);
