...
{
    /// <summary>
    /// A "random" number generator that always returns the maxValue parameter given.  Again this may be useful in testing, testing the upper range or repeatedly returning a value.  Also used in
