...
{
    /// <summary>
    /// Implementation of IRandom that is basically wrapper around the built in .NET random number generator.
    /// Not the best RNG out there in terms of statistical non-bias, etc., however it makes a good starting point.
    /// </summary>
