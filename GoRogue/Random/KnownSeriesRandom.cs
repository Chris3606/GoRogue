...
namespace GoRogue.Random
{
    ...
    /// </summary>
    /// <remarks>
    /// This class may be useful for testing, when you want to specify the numbers returned by an RNG without drastically modifying
    /// any code using the RNG.
    /// </remarks>
    public class KnownSeriesGenerator : IGenerator
    {
        ...
        /// <summary>
        /// Creates a new known series generator, with parameters to indicate which series to use for the integer, unsigned integer, double, bool,
        /// and byte-based RNG functions.  If null is specified, no values of that type may be returned, and functions that try
        /// to return a value of that type will throw an exception.
        /// </summary>
        ...
        /// <summary>
        /// Gets the next number in the underlying int series. If the value is less than 0 or greater than/equal to
        ...
        /// <summary>
        /// Gets the next number in the underlying series. If the value is less than minValue or greater than/equal to
        /// maxValue, throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Gets the next integer in the underlying series.  If the integer is equal to int.MaxValue, throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Returns the next double in the underlying series.  If the double is less than 0.0 or greater than/equal to 1.0,
        /// throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Returns the next double in the underlying series.  If the double is less than 0.0 or greater than/equal to maxValue,
        /// throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Returns the next double in the underlying series. If the double is less than minValue or greater than/equal to maxValue,
        /// throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Returns the next unsigned integer in the underlying series.  If the value is equal to uint.MaxValue,
        /// throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Returns the next unsigned integer in the underlying series.  If the value is greater than or equal to maxValue,
        /// throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Returns the next unsigned integer in the underlying series.  If the value is less than minValue, or greater than/equal to maxValue,
        /// throws an exception.
        /// </summary>
        ...
        /// <summary>
        /// Resets the random number generator, such that it starts returning values from the beginning of the underlying
        /// series.
        /// </summary>
