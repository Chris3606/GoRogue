...
{
    /// <summary>
    /// "RNG" that takes in a series of integers, and simply returns the next one in the list.  For example, for a series of numbers 3 long, calling Next the first time returns the first number,
    /// the second time it returns the second number, the third time the third number.  This might be used for testing, where you want to test code involving
    /// random numbers on a specific number or set of numbers.
    /// </summary>
