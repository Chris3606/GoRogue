...
{
    /// <summary>
    /// A "random" number generator that always returns the minValue parameter given, or 0 on the Next overload that only takes maxValue.  Again, may be useful for testing.  Also used in DiceExpression
    /// for certain minimum roll functions.
    /// </summary>
