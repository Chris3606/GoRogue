...
{
    /// <summary>
    /// A class that contains a rectangle Area that is automatically "locked" to being inside the BoundingBox. A typical use might be keeping track of 
    /// a camera view area.
    /// </summary>
    public class BoundedRectangle
    {
        ...
        /// <summary>
        /// The rectangle that is guaranteed to be contained within the BoundingBox.  Although it does not specifically provide a set accessor,
        /// this property is returning a reference and as such may be assigned to.  Whenever the rectangle is retrieved, if it is not contained within
        /// BoundingBox it will be modified as necessary to keep it within those bounds.
        /// </summary>
        ...
        /// <summary>
        /// The rectangle which Area is automatically bounded to.  Similar to area, although this property does not explicitly provide a set accessor,
        /// it is returning a reference so the property may be assigned to.
        /// </summary>
