...
namespace GoRogue
{
    ...
    public struct Rectangle : IEquatable<Rectangle>
    {
        ...
        /// <param name="horizontalRadius">Number of tiles to the left and right of the center point that are included within the rectangle.</param>
        /// <param name="verticalRadius">Number of tiles to the top and bottom of the center point that are included within the rectangle.</param>
        ...
        /// <returns>True if the given rectangle is completely contained within the current one, false otherwise.</returns>
        ...
        /// </summary>
        /// <param name="horizontalChange">Number of additional tiles to include on the left/right of the rectangle.</param>
        /// <param name="verticalChange">Number of additional tiles to include on the top/bottom of the rectangle.</param>
        ...
        /// <summary>
        /// Returns the rectangle that represents the intersection of the two rectangles specified, or the empty rectangle
        /// if the specified rectangles do not intersect.
        /// </summary>
        /// <param name="r1">First rectangle.</param>
        /// <param name="r2">Second rectangle.</param>
        /// <returns>Rectangle representing the intersection of r1 and r2, or the empty rectangle if the two rectangles do not intersect.</returns>
        ...
        /// <param name="r1">First rectangle.</param>
        /// <param name="r2">Second rectangle.</param>
        /// <returns>The smallest possible rectangle that includes the entire area of both r1 and r2.</returns>
        ...
        /// <returns>true if the area of the two rectangles encompass the exact same area, false otherwise.</returns>
        ...
        /// <returns>true if the object is a Rectangle instance and encompasses the same area, false otherwise.</returns>
