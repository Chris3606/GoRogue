...
namespace GoRogue.DoublePriorityQueue
{
    ...
    /// </summary>
    /// <typeparam name="T">The values in the queue.  Must extend the DoubleFastPriorityQueueNode class</typeparam>
    public sealed class DoubleFastPriorityQueue<T> : IEnumerable<T>
        where T : DoubleFastPriorityQueueNode
    {
        ...
        public DoubleFastPriorityQueue(int maxNodes)
        {
#if DEBUG
            if (maxNodes <= 0)
            {
