namespace GoRogue.MapViews
{
    ...
    /// "set" functionality, see SettableTranslationMap.
    /// </summary>
    /// <remarks>
    ...
    /// 
    /// This class allows you to build descendant classes that override the TranslateGet
    /// method for simple mapping, or the this properties if you need full access to the underlying data
    ...
    public abstract class TranslationMap<T1, T2> : IMapView<T2>
    {
        ...
        /// <summary>
        /// Given an X and Y value, translates and returns the "value" associated with that location.  This function
        ...
        /// <summary>
        /// Given a Coord, translates and returns the "value" associated with that location.  this[int x, int y] calls
