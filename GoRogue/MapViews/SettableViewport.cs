...
{
    /// <summary>
    /// Similar to Viewport, but implements ISettableMapView and thus implements set functionality via relative coordinates.
    /// </summary>
    ...
    public class SettableViewport<T> : Viewport<T>, ISettableMapView<T>
    {
        ...
        /// </summary>
        /// <param name="relativePosition">Viewport-relative position of the location to retrieve/set the value for.</param>
