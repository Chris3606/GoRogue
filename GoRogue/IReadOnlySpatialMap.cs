...
namespace GoRogue
{
    ...
    /// <summary>
    /// See ISpatialMap documentation.  Similar in principle to the C# standard IReadOnlyList/IReadOnlyCollection interface.
    /// Simply exposes only those functions of the ISpatialMap interface that do not allow direct modification of the data
    /// (eg. adding/moving/removing items).  This can allow for direct exposure of an ISpatialMap as a property of type
    /// IReadOnlySpatialMap, without allowing such an exposure to break data encapsulation principles of something
    /// like a game map.
    /// </summary>
