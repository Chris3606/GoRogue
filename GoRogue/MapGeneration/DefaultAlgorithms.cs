...
namespace GoRogue.MapGeneration
{
    ...
    /// </summary>
    /// <remarks>
    /// These algorithms serve as a quick way to generate a map and demonstrate how generation steps may be used together. Feel
    ...
    public static class DefaultAlgorithms
    {
                                                                                  ...
                                                                                  ITunnelCreator? tunnelCreationMethod = null)
        {
            ...
            // 1. Generate areas in the map smoothed with the cellular automata algorithm
            ...
            // 2. Connect areas generated by this algorithm by connecting each area to its closest neighbor
