...
namespace GoRogue.MapGeneration
{
	...
	public static class QuickGenerators
	{
																	  ...
																	  int attemptsPerRoom = 10)
		{
			...
			// Optimization to allow us to use the existing map if the existing map is an ArrayMap.  otherwise we allocate a temporary ArrayMap and copy it onto
			// the original at the end, to make sure that we set each value in the final array map only once in the case that it is something less "quick" than an
			// ArrayMap.
