...
namespace GoRogue.MapGeneration.Generators
{
    ...
    public static class MazeGenerator
    {
        ...
        /// <param name="crawlerChangeDirectionImprovement">Out of 100, how much to increase the chance of the crawler changing direction each step. Once it changes direction, the chance resets to 0 and increases by this amount.</param>
        /// <param name="saveDeadEndChance">After the crawler finishes, the small dead ends will be trimmed out. This value indicates the chance out of 100 that the dead end remains.</param>
