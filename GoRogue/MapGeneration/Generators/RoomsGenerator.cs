...
{
	/// <summary>
	/// Carves out rooms in a map.  Rooms will not be connected -- for automatic connection of rooms generated by this generator, see
			...
			while (roomCounter != 0)
			{
				...
				while (tryCounterCreate != 0)
				{
					...
					while (tryCounterPlace != 0)
					{
						...
						bool intersected = rooms.Any(existingRoom => roomBounds.Intersects(existingRoom));
						/*
