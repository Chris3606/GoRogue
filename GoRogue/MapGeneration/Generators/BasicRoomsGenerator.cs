...
{
	/// <summary>
	/// Carves out rooms in a map using a basic process of generating a room, and trying to place that room without intersecting another.  Generated rooms will not
	/// be connected -- for automatic connection of rooms generated by this algorithm, see GoRogue.MapGeneration.QuickGenerator.GenerateRandomRoomsMap().
	/// </summary>
