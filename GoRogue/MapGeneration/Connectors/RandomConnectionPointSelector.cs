...
{
    /// <summary>
    /// Implements a the selection algorithm that simply selects random points from the given MapArea's positions lists, using the RNG specified, or the default
    /// rng if null is given.
    /// </summary>
