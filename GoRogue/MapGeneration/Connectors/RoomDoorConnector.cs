...
namespace GoRogue.MapGeneration.Connectors
{
    ...
    static public class RoomDoorConnector
    {
        ...
        /// <param name="minSidesToConnect">Minimum sides of the room to process.</param>
        /// <param name="maxSidesToConnect">Maximum sides of the room to process.</param>
        /// <param name="cancelSideConnectionSelectChance">A chance out of 100 to cancel selecting sides to process (per room).</param>
        /// <param name="cancelConnectionPlacementChance">A chance out of 100 to cancel placing a door on a side after one has been placed (per room).</param>
        /// <param name="cancelConnectionPlacementChanceIncrease">Increase the <paramref name="cancelConnectionPlacementChance"/> value by this amount each time a door is placed (per room).</param>
