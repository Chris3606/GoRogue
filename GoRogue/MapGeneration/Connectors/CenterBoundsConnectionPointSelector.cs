...
{
    /// <summary>
    /// Selects the center points of the bounding boxes of each map area. On concave map areas, because the center point of the bounding box is not actually guaranteed
    /// to be among the MapArea's walkable tiles, connecting these two points is not guaranteed to actually connect the entirety of the two areas.
    /// </summary>
