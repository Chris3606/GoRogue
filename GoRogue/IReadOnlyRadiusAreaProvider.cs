...
namespace GoRogue
{
    ...
    public interface IReadOnlyRadiusAreaProvider
    {
        ...
        /// radius and bounds specified (as applicable). See RadiusAreaProvider class description for details on the ordering.
        /// Safe to expose in read-only class, since it does not modify the public interface of the RadiusAreaProvider.
        /// </summary>
