...
namespace GoRogue
{
    ...
    public class Coord
    {
        ...
        /// </param>
        /// <returns>
        /// All 8 neighbors of the given location.
        /// </returns>
        ...
        /// <summary>
        /// Gets all 8 neighbors of the given location, in clockwise order, starting with the
        /// neighbor in the direction given (or UP by default).
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        /// <param name="startingDirection">
        /// Direction to start with. Defaults to UP.
        /// </param>
        /// <returns>
        /// All 8 neighbors of the given location, in clockwise order.
        /// </returns>
        ...
        /// <summary>
        /// Gets all 8 neighbors of the given location, in counter-clockwise order, starting with the
        /// neighbor in the direction given (or UP by default).
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        ...
        /// </param>
        /// <returns>
        /// All 8 neighbors of the given location, in counter-clockwise order.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The 4 cardinal neighbors of the given location, in order UP, DOWN, LEFT, RIGHT.
        /// </returns>
        ...
        /// <summary>
        /// Gets the 4 cardinal neighbors of the given location, in clockwise order, starting with
        /// the neighbor in the direction given (or UP by default). If the direction given is a
        /// diagonal, it starts with the closest clockwise cardinal neighbor.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// The 4 cardinal neighbors of the given location, in clockwise order.
        /// </returns>
        ...
        /// <summary>
        /// Gets the 4 cardinal neighbors of the given location, in counter-clockwise order, starting
        /// with the neighbor in the direction given (or UP by default). If the direction given is a
        /// diagonal, it starts with the closest counter-clockwise cardinal neighbor.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// The 4 cardinal neighbors of the given location, in counter-clockwise order.
        /// </returns>
        ...
        /// <summary>
        /// Gets the 4 diagonal neighbors of the given location, in order UP_LEFT, UP_RIGHT,
        ...
        /// </param>
        /// <returns>
        /// The 4 diagonal neighbors of the given location, in order UP_LEFT, UP_RIGHT, DOWN_LEFT, DOWN_RIGHT.
        /// </returns>
        ...
        /// <summary>
        /// Gets the 4 diagonal neighbors of the given location, in clockwise order, starting with
        /// the neighbor in the direction given (or UP_RIGHT by default). If the direction given is a
        /// cardinal, it starts with the closest clockwise diagonal neighbor.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        /// <param name="startingDirection">
        /// Direction to start with. Defaults to UP_RIGHT.
        /// </param>
        /// <returns>
        /// The 4 diagonal neighbors of the given location, in clockwise order.
        /// </returns>
        ...
        /// <summary>
        /// Gets the 4 diagonal neighbors of the given location, in counter-clockwise order, starting
        /// with the neighbor in the direction given (or UP_LEFT by default). If the direction given
        /// is a cardinal, it starts with the closest counter-clockwise diagonal neighbor.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        /// <param name="startingDirection">
        /// Direction to start with. Defaults to UP_LEFT.
        /// </param>
        /// <returns>
        /// The 4 diagonal neighbors of the given location, in counter-clockwise order.
        /// </returns>
        ...
        /// <summary>
        /// Gets all neighbors of the specified location, based on the distance calculation specified
        /// (MANHATTAN yields 4 neighbors, others yield 8, with cardinals returned before diagonals).
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        /// <param name="distanceCalc">
        /// Distance calculation used to determine which tiles are consdered adjacent.
        /// </param>
        /// <returns>
        /// All neighbors of the given location, according to the distance calculation specified.
        /// </returns>
        ...
        /// <summary>
        /// Gets all neighbors of the specified location, based on the radius shape specified
        /// (DIAMOND/OCTAHEDRON yields 4 neighbors, others yield 8, with cardinals returned before diagonals).
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        /// <param name="shape">
        /// Radius shape used to determine which tiles are consdered adjacent.
        /// </param>
        /// <returns>
        /// All neighbors of the given location, according to the radius shape specified.
        /// </returns>
        ...
        /// <summary>
        /// Gets all neighbors of the specified location, in clockwise order, based on the distance
        /// calculation specified (MANHATTAN yields 4 neighbors, others yield 8). The first direction
        /// returned is the one specified as startingDirection, or the closest clockwise cardinal if
        /// it is a diagonal and MANHATTAN is used.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        ...
        /// </param>
        /// <param name="startingDirection">
        /// The direction to start with. Defaults to UP.
        /// </param>
        /// <returns>
        /// All neighbors of the given location, according to the distance calculation specified.
        /// </returns>
        ...
        /// <summary>
        /// Gets all neighbors of the specified location, in clockwise order, based on the radius
        /// shape specified (DIAMOND/OCTAHEDRON yields 4 neighbors, others yield 8). The first
        /// direction returned is the one specified as startingDirection, or the closest clockwise
        /// cardinal if it is a diagonal and DIAMOND/OCTAHEDRON is used.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        ...
        /// <summary>
        /// Gets all neighbors of the specified location, in counter-clockwise order, based on the
        /// distance calculation specified (MANHATTAN yields 4 neighbors, others yield 8). The first
        /// direction returned is the one specified as startingDirection, or the closest
        /// counter-clockwise cardinal if it is a diagonal and MANHATTAN is used.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
        ...
        /// <summary>
        /// Gets all neighbors of the specified location, in counter-clockwise order, based on the
        /// radius shape specified (DIAMOND/OCTAHEDRON yields 4 neighbors, others yield 8). The first
        /// direction returned is the one specified as startingDirection, or the closest
        /// counter-clockwise cardinal if it is a diagonal and DIAMOND/OCTAHEDRON is used.
        /// </summary>
        /// <param name="startingLocation">
        /// Location to return neighbors for.
        /// </param>
