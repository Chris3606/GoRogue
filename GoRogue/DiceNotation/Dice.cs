...
{
    /// <summary>
    /// This is likely the class you really care about the most.  Basically just a static class that has methods for tieing all of the DiceNotation classes together.  It has functions for parsing an expression,
    /// rolling based upon a given expression, and others.
    /// </summary>
    public static class Dice
    {
        ...
        /// <summary>
        /// Parse the specified string into a DiceExpression.  If you intend to roll a given expression multiple times, chances are you want to use this once to get yourself a DiceExpression instance representing
        /// that particular roll, and store that somewhere.  Then, use the Roll function in DiceExpression to roll it.  This is faster as it means the slow part (using regex to take apart the expression)
        /// happens only once.
        /// </summary>
        /// <param name="expression">The string dice expression to parse, in dice notation format. Ex. 3d6+4.</param>
