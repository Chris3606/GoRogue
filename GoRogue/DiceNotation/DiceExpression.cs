...
{
    /// <summary>
    /// A class representing a dice expression that can be rolled.  Typically you will not construct these yourself, rather you might use this if you had a roll you needed to do often; you can use
    /// the Dice class's Parse function to retrieve one of these from your string expression, and then use this class's Roll function whenever you need to roll it.  This ensures that the parsing portion,
    /// the part that uses (relatively expensive) regex pattern-matching, is done only once.
    /// </summary>
